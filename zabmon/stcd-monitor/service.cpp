...
#include <stcd-monitor/grpcadapter.h>
#include <stcd-monitor/service.h>
...
::grpc::Status Service::createHost(::grpc::ServerContext* /*context*/,
                                   const proto::CreateHostRequest* request,
                                   proto::Host* response)
{
  Host host;
  try {
    const proto::Host& hostFromgRpc = request->host();
...
::grpc::Status Service::updateHost(
    ...
    ::zab::mon::proto::Host* response)
{
  Host host;
  try {
    const ::zab::mon::proto::Host& hostFromgRpc = request->host();
    host = GRPCAdapter::toHost(hostFromgRpc);
...
::grpc::Status Service::listHosts(
    ...
    ::zab::mon::proto::ListHostsResponse* response)
{
  try {
...
::grpc::Status Service::listGroups(
    ...
    ::zab::mon::proto::ListGroupsResponse* response)
{
  try {
...
::grpc::Status Service::listTemplates(
    ...
    ::zab::mon::proto::ListTemplatesResponse* response)
{
  try {
    std::vector<std::string> filter;
    for(const std::string& groupId : request->groups_ids()) {
    ...
    for(const Template& temp : temps) {
      std::unique_ptr<proto::Template> templateResult =
          std::make_unique<proto::Template>();
...
::grpc::Status Service::listItems(
    ...
    ::zab::mon::proto::ListItemsResponse* response)
{
  try {
    ...
    for(const Item& item : items) {
      std::unique_ptr<proto::Item> itemResult = std::make_unique<proto::Item>();
...
::grpc::Status Service::createTemplate(
    ...
    ::zab::mon::proto::Template* response)
{
  Template temp;
  try {
...
::grpc::Status Service::listItemsValues(
    ...
    ::zab::mon::proto::ListItemsValuesResponse* response)
{
  std::vector<ItemValues> values;
  try {
    std::vector<Item> items{};
    for(const proto::Item& item : request->items()) {
