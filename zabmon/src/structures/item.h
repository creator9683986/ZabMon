...
struct Item {
  ...
  static ValueType convertValueTypeFromProto(::zabmon::ValueType valueType);
  static zabmon::ValueType convertValueTypeToProto(ValueType valueType);
  static ItemType convertItemTypeFromProto(zabmon::ItemType itemType);
  static zabmon::ItemType convertItemTypeToProto(ItemType itemType);
};
}  // namespace zab::mon
